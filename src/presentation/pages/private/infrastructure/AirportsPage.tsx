...
export default function AirportsPage() {
  ...
  // ← nuevo: imagen abierta en el visor grande (null = cerrado)
                  ...
                  >
                    <td className="px-5 py-4">
                      <AirportImage
                        ...
                        onClick={() =>
                          airport.image_url &&
                          setSelectedImage(airport.image_url)
                        }
                      />
                    </td>
      ...
      {selectedImage && (
        ...
        >
          ...
          >
            <button
              onClick={() => setSelectedImage(null)}
              className="absolute -top-10 right-0 text-3xl leading-none text-white hover:text-gray-300"
              aria-label="Cerrar"
            >
              ×
            </button>
  ...
  if (airport.image_url) {
    return (
      <img
        ...
        alt={airport.nombre}
        onClick={onClick}
        className="h-12 w-16 cursor-pointer rounded-lg border object-cover transition-opacity hover:opacity-80"
      />
    )
  }
